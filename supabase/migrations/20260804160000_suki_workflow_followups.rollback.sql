drop function if exists public.transfer_task_handoff(uuid, uuid, text, date);

-- Restore the previous due-date-only daily digest. Delivery audit rows and all
-- user data remain intact.
